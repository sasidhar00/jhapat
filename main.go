...
func main() {
        ...
        dbURL := os.Getenv("libsql://jhapat-db-sasidhar00.aws-ap-south-1.turso.io")
        dbToken := os.Getenv("eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJhIjoicnciLCJpYXQiOjE3NjgzODQyODAsImlkIjoiMjNiMDQ1YzUtMmY0Ni00Mzk3LWI5OTUtMzNlM2VkMDI3ZTY4IiwicmlkIjoiYThjNDYxZDktNTg5ZS00NTRmLWI4NmItYTM4MDI4OTEyZDUzIn0.DZYIH2uXBBwCZtFNoXB02mLwhtWIlbjjEmvGGd_3PXB9KgCaQ8-HnMexMmEAhq-YTfKF_ii96qrLUVts2JykCg")
